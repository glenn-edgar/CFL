...
void allocate_columns_CFL(Handle_CFL_t* handle, int number_of_columns) {
  ...
  column_control =
    (Column_control_CFL_t*)allocate_once_CFL(handle, sizeof(Column_CFL_t));
  ...
  column = (Column_CFL_t*)allocate_once_CFL(handle, sizeof(Column_CFL_t) *
    number_of_columns);
  ...
  column_control->node_cell = (Node_cell_CFL_t*)allocate_once_CFL(
    handle, sizeof(Node_cell_CFL_t) * number_of_columns);
  column_control->node_control.active_array =
    (unsigned short*)allocate_once_CFL(handle, sizeof(unsigned short) *
      number_of_columns);
