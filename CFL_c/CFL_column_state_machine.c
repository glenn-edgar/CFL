...
static int change_column_state_CFL(void *input, void *aux_fn, void *params, Event_data_CFL_t *event_data);
static void one_shot_change_column_state_CFL(void *input, void *params, Event_data_CFL_t *event_data);
...
void Initialize_column_state_machine_CFL(void *input)
{
    ...
    Store_column_function_CFL(input, "CHANGE_COLUMN_STATE", change_column_state_CFL);
    Store_one_shot_function_CFL(input, "CHANGE_COLUMN_STATE", one_shot_change_column_state_CFL);
}
