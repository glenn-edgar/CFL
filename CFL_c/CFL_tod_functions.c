...
static void fill_out_verify_tod(void *input,const char *test_function, short doy, short month, short dow, short hour, short minute, short second,bool terminate_flag);
...
void Asm_verify_tod_lt(void *input, short doy, short month, short dow, short hour, short minute, short second, bool terminate_flag){
     ...
     fill_out_verify_tod(input,"test_tod_lt",doy,month, dow, hour, minute, second,terminate_flag);
...
void Asm_verify_tod_le(void *input, short doy, short month, short dow, short hour, short minute, short second, bool terminate_flag){
     ...
     fill_out_verify_tod(input,"test_tod_le",doy,month, dow, hour, minute, second,terminate_flag);
...
void Asm_verify_tod_eq(void *input, short doy, short month, short dow, short hour, short minute, short second, bool terminate_flag){
     ...
     fill_out_verify_tod(input,"test_tod_eq",doy,month, dow, hour, minute, second,terminate_flag);
...
void Asm_verify_tod_ge(void *input, short doy, short month, short dow, short hour, short minute, short second, bool terminate_flag){
     ...
     fill_out_verify_tod(input,"test_tod_ge",doy,month, dow, hour, minute, second,terminate_flag);
...
void Asm_verify_tod_gt(void *input, short doy, short month, short dow, short hour, short minute, short second, bool terminate_flag){
     ...
     fill_out_verify_tod(input,"test_tod_gt",doy,month, dow, hour, minute, second,terminate_flag);
...
static void fill_out_verify_tod(void *input,const char *test_function, short Doy, short month, short dow, short hour, short minute, short second,bool terminate_flag)
{
    ...
    wait_tod->minute = minute;
    wait_tod->second = second;
    Asm_verify_CFL(input,test_function,terminate_flag,NULL, wait_tod);
}
