...
function add_bools(symbol_table)
    symbol_table.add_boolean("test_tod_lt", 'test_tod_condition_lt')
    symbol_table.add_boolean("test_tod_le", 'test_tod_condition_le')
    symbol_table.add_boolean("test_tod_eq",'test_tod_condition_eq')
    symbol_table.add_boolean("test_tod_ge",'test_tod_condition_ge')
    symbol_table.add_boolean("test_tod_gt", 'test_tod_condition_gt')
end

function load_bo(symbol_table)
    symbol_table.add_code("test_tod_condition_lt", test_tod_condition_lt)
    symbol_table.add_code("test_tod_condition_le", test_tod_condition_le)
    symbol_table.add_code("test_tod_condition_eq", test_tod_condition_eq)
    symbol_table.add_code("test_tod_condition_ge", test_tod_condition_ge)
    symbol_table.add_code("test_tod_condition_gt", test_tod_condition_gt)
end

function assemble_headers()
return [[
    bool test_tod_condition_lt(void *input, void *user_data, Event_data_CFL_t *event_data);
    bool test_tod_condition_le(void *input, void *user_data, Event_data_CFL_t *event_data);
    bool test_tod_condition_eq(void *input, void *user_data, Event_data_CFL_t *event_data);
    sbool test_tod_condition_ge(void *input, void *user_data, Event_data_CFL_t *event_data);
    bool test_tod_condition_gt(void *input, void *user_data, Event_data_CFL_t *event_data);
...
bool test_tod_condition_ge(void *input, void *user_data, Event_data_CFL_t *event_data)
{
    Wait_tod_CFL_t *wait_tod = (Wait_tod_CFL_t *)user_data;
    Time_control_CFL_t *time_control = Get_time_control_CFL(input);
    if (wait_tod->day_of_year >= 0)
