...
Store_one_shot_function("TEST_ONE_SHOT",'test_one_shot',test_one_shot_code)  
Store_one_shot_function("TEST_BID_ONE_SHOT",'test_bid_one_shot',test_one_bid_shot_code)  
