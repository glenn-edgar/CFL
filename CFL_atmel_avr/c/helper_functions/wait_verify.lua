...
local verify_template_data_rom = [[
    const Verify_control_ROM_CFL_t *%s_rom = { %s, %s, %s };\n;  // terminate flag,user data,one shot function
]]
...
local wait_time_delay_ram = [[
    const While_time_control_RAM_t *%s_ram = { 0,0 };\n current count
]]
