...
state_change_event = generate_event(101,false,'NULL')
state_machine_event_1 = generate_event(102,false,'NULL')
state_machine_event_2 = generate_event(103,false,'NULL')
state_machine_event_3 = generate_event(104,false,'NULL')
state_machine_event_4 = generate_event(105,false,'NULL')
