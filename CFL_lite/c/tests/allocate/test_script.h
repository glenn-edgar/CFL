...
static Time_control_CFL_t nmkcdgbfhz;




static Engine_control_CFL_t suanbrnrps;
...
static unsigned ahnpyehszp;


/* current heap pointer */

static char* qyucmvtfhk;


/* heap block area */

static CS_MEMORY_CONTROL vcqdinxskb;
...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*/
const struct Handle_CFL_t dponmzmekw =
{
  ...
  .time_control = &nmkcdgbfhz,
  .engine_control =&suanbrnrps,
  ...
  .remaining_heap_size = &ahnpyehszp,
  .current_heap_location = &qyucmvtfhk,
  .private_heap   = &vcqdinxskb,
